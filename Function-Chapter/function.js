...
// ChatGPT Se liya hua Syntax ---> 2. object ke ander arrow function ka use kar ke bhi sahi value kaise le skate hai.
const person = {
  name: "John",
  age: 30,
...
//  ChatGPT Se liya hua Syntax ---> Arrow function ka this work q nhi karta yaha hai waza.
...
// console.log(person3.greet()); //returns use is tara se call karte hai.
// Output: Hello, my name is undefined and I am undefined years old.
person3.greet(); //console use is tara se call karte hai.
